...
def identify_dups(vcf, chrom, suffix, dup_path):
    ...
    with gzip.open(vcf, 'rt') as data, \
         gzip.open(f'{dup_path}/{chrom}.{suffix}.dup_sites.txt.gz', 'wt') as dup_file:
...
identify_dups(vcf=sys.argv[1], chrom=sys.argv[2], suffix=sys.argv[3], dup_path=sys.argv[4])